...
var _ = require('underscore'),
  ...
  debugValidation = require('debug')('node-elasticsearch-sync:validation');
...
var watcherValid = function (watcher, position) {
  debugValidation('Validating watch #%s: %s', position, watcher);
...
module.exports = {
  ...
  validateArgs: function (args) {
    debugValidation('Validating init arguments: %s', JSON.stringify(args));
    ...
    if (args.length !== 3) {
      ...
      * */
      ...
      debugValidation('init arguments valid!');
    }
