...
Still confused? Get inspired by this [Sample Setup](SAMPLE-pre-v1.0.0.js)
...
Check [GitHub issues](https://github.com/toystars/node-elasticsearch-sync/issues) for current issues.
